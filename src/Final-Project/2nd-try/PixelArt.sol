...
contract PixelArt {
    ...
    function generateSvg() public view virtual returns (string memory) {
    ...
    function getPixelFromCoords(
        uint256 x,
        uint256 y
    ) public view virtual returns (uint8[4] memory) {
    ...
    function garbage() public pure virtual returns (string memory) {
    ...
    function _setPixels(uint8[2304] calldata _pixels) internal virtual {
        pixels = _pixels;
    }

    function _setPixelsAssembly() internal virtual {
        assembly {
            let pxNum := 0
            for {
                let wordNum := 0
    ...
    function _setPixelsAssembly2() internal virtual {
        assembly {
            let pxNum := 0
            for {
                let wordNum := 0
    ...
    function _setPixels2(uint8[2304] calldata _pixels) internal virtual {
        pixels = _pixels;
    }
}